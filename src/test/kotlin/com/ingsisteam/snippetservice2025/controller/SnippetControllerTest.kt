...
class SnippetControllerTest {
    ...
    private val userId = "test-user@example.com"
    private val SNIPPET_ID = 1L
    ...
    fun `getAllSnippets should return 200 with list of snippets when no filter is provided`() {
        val snippet1 = createDummySnippetResponseDTO(id = 10L, name = "Snippet 1")
        val snippet2 = createDummySnippetResponseDTO(id = 11L, name = "Snippet 2")
    ...
    fun `getAllSnippets should return 200 with filtered list of snippets when filter is provided`() {
        ...
        val snippet1 = createDummySnippetResponseDTO(id = 20L, name = filterName)
    ...
    fun `getSnippet should return 404 when snippetService throws SnippetNotFoundException`() {
        ...
        val exception = assertThrows(SnippetNotFoundException::class.java) {
